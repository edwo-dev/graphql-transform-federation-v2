...
describe('Transform Federation', function () {
    it('should add a _service field', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    executableSchema = (0, schema_1.makeExecutableSchema)({
                        typeDefs: "\n        type Product {\n          id: ID!\n        }\n      ",
                        resolvers: {},
                    });
                    federationSchema = (0, transform_federation_1.transformSchemaFederation)(executableSchema, {
                        Product: {
                            keyFields: ['id'],
                        },
                    });
                    _a = expect;
                    return [4 /*yield*/, (0, execute_1.execute)({
                            schema: federationSchema,
                            document: (0, language_1.parse)("\n          query {\n            _service {\n              sdl\n            }\n          }\n        "),
                        })];
                case 1:

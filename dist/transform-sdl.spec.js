...
describe('transform-sdl', function () {
    it('should add key directives to sdl', function () {
        expect((0, transform_sdl_1.addFederationAnnotations)("\n      type Product @keep {\n        id: Int\n      }", {
            Product: {
                keyFields: ['id'],
            },
        })).toEqual((0, dedent_1.default)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n      type Product @keep @key(fields: \"id\") {\n        id: Int\n      }"], ["\n      type Product @keep @key(fields: \"id\") {\n        id: Int\n      }"]))));
    });
    it('should throw an error if not all keys were added', function () {
        expect(function () {
            (0, transform_sdl_1.addFederationAnnotations)("\n        type Product {\n          id: Int\n        }\n      ", {
                NotProduct: {
    ...
    it('should convert types to extend types', function () {
        ...
        })).toEqual((0, dedent_1.default)(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n      extend type Product {\n        id: Int\n      }"], ["\n      extend type Product {\n        id: Int\n      }"]))));
    });
    it('should add directive to fields', function () {
        ...
        })).toEqual((0, dedent_1.default)(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n      type Product {\n        id: Int @external @provides(fields: \"mock provides\") @requires(fields: \"a { query }\")\n      }"], ["\n      type Product {\n        id: Int @external @provides(fields: \"mock provides\") @requires(fields: \"a { query }\")\n      }"]))));
    });
